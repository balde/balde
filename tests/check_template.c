...
void
test_template_generate_source_single_var_with_single_quoted_includes(void)
{
    gchar *rv = balde_template_generate_source("bola",
        "ads {{ guda }} qwe\n"
        "\n"
...
test_template_generate_source_multiple_vars_and_lines_with_function_calls_and_single_quotes(void)
{
    gchar *rv = balde_template_generate_source("bola",
        ...
        "{{ bola() }}\n"
        "\n"
        "{{ chunda(quico, 'cola', -2, 1.5, \"chaves\", TRUE, popis, 'bo\\'la') }} {{ asd('XD') }}\n"
        "{{balde}} qwe");
    g_assert_cmpstr(rv, ==,
        "// WARNING: this file was generated automatically by balde-template-gen\n"
        "\n"
...
test_template_parse(void)
{
    ...
    balde_assert_template_include(blocks->next->next->next->next->next->next->next,
        "asd.h");
    g_assert(blocks->next->next->next->next->next->next->next->next == NULL);
...
main(int argc, char** argv)
{
    ...
    g_test_add_func("/template/generate_source_single_var_with_single_quoted_includes",
        test_template_generate_source_single_var_with_single_quoted_includes);
